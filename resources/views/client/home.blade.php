...
@section('content')
      ...
      <section class="welcome_area">
        <div class="welcome_slides owl-carousel">
            ...
            <!-- Single Slide Start -->
            <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(resource/img/bg-img/{{$slide->image}});">
    ...
    <!-- ****** Welcome Slides Area End ****** -->
       ...
       <section class="top_catagory_area d-md-flex clearfix">
        <!-- Single Catagory -->
        <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(resource/img/bg-img/bannerheadweb02.jpg);">
        ...
        <!-- Single Catagory -->
        <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(resource/img/bg-img/bannerweb28.902.png);">
            <div class="catagory-content">
            ...
            <div class="row karl-new-arrivals">
                ...
                <div class="col-12 col-sm-6 col-md-4 single_gallery_item kids man wow fadeInUpBig" data-wow-delay="0.7s">
                    ...
                    <div class="product-img">
                        <img src="resource/img/product-img/{{$product['image']}}" alt="">
                    ...
                    <div class="product-description">
                        ...
                        <p><a href="{{route('productdetail',$product->id)}}">{{$product->name}}</a></p>
                        <!-- Add to Cart -->
    ...
    <!-- ****** Offer Area Start ****** -->
    <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url(resource/img/bg-img/bg-5.jpg);">
        <div class="container h-100">
                        ...
                        <div class="single-testimonial-area text-center">
                            ...
                            <div class="testimonial-info d-flex align-items-center justify-content-center">
                                <div class="tes-thumbnail">
                                    <img src="resource/img/bg-img/tes-1.jpg" alt="">
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-5">
                                    <div class="quickview_pro_img">
                                        <img src="resource/img/product-img/product-1.jpg" alt="">
                                    </div>
                                </div>
