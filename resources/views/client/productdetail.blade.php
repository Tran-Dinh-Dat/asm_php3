            ...
            <div class="row">
                    ...
                    <div class="single_product_thumb">
                        <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                            ...
                            <ol class="carousel-indicators">
                                <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url({{asset('resource/img/product-img/')}}/{{$detail->image}});">
                                </li>
                                <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url({{asset('resource/img/product-img/')}}/{{$detail->image}});">
                                </li>
                                <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url({{asset('resource/img/product-img/')}}/{{$detail->image}});">
                                </li>
                                <li data-target="#product_details_slider" data-slide-to="3" style="background-image: url({{asset('resource/img/product-img/')}}/{{$detail->image}});">
                                </li>
                            </ol>

                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <a class="gallery_img" href="{{asset('resource/img/product-img/')}}/{{$detail->image}}">
                                    <img class="d-block w-100" src="{{asset('resource/img/product-img/')}}/{{$detail->image}}" alt="First slide">
                                </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{asset('resource/img/product-img/')}}/{{$detail->image}}">
                                    <img class="d-block w-100" src="{{asset('resource/img/product-img/')}}/{{$detail->image}}" alt="Second slide">
                                </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{asset('resource/img/product-img/')}}/{{$detail->image}}">
                                    <img class="d-block w-100" src="{{asset('resource/img/product-img/')}}/{{$detail->image}}" alt="Third slide">
                                </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{asset('resource/img/product-img/')}}/{{$detail->image}}">
                                    <img class="d-block w-100" src="{{asset('resource/img/product-img/')}}/{{$detail->image}}" alt="Fourth slide">
                                </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12 col-md-6">
                    <div class="single_product_desc">
                        ...
                        <h4 class="title"><a href="#">{{$detail->name}}</a></h4>

                        <h4 class="price">{{number_format($detail->price)}} đ</h4>
